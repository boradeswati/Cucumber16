...
public class HooksStepDef {
	...
	public void beforeSetup1(){
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\yshub\\Desktop\\Swati\\64\\New folder\\chromedriver_win32_B39\\chromedriver.exe");
	...
	@Then("^checks user \"([^\"]*)\" first name is present$")
...
//	}
	...
	public void tearDown1(){
		System.out.println("in After order 2");
		driver.quit();
		driver =null;
		System.out.println("====================================================================");
	}
	...
	public void tearDown2(){
		System.out.println("in After order 1");
